...
local Library = {
	...
	KeySystem = {
		Enabled = true,
		ValidKey = "testcw",
		GetKeyLink = "https://work.ink/2dxZ/hell-hub-key",
		Title = "Hell Hub - Key System",
...
function Library:checkKey(callback)
	if not self.KeySystem.Enabled then
		callback(true)
		return
	end
	...
	title.Text = self.KeySystem.Title
	...
	subtitle.Text = self.KeySystem.Subtitle
	...
	getKeyBtn.MouseButton1Click:Connect(function()
		if setclipboard then
			setclipboard(self.KeySystem.GetKeyLink)
	...
	checkKeyBtn.MouseButton1Click:Connect(function()
		if keyInput.Text == self.KeySystem.ValidKey then
